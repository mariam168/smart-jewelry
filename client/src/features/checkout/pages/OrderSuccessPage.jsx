...
const OrderSuccessPage = () => {
  ...
  const getOrderStatusLabel = (status) => {
    ...
    const translated = t(
      `orderSuccess.statuses.${statusKey}`,
    );

    return translated.startsWith(
      "orderSuccess.statuses.",
    )
  ...
  const getPaymentMethodLabel = (method) => {
    ...
    const translated = t(
      `orderSuccess.paymentMethods.${methodKey}`,
    );

    return translated.startsWith(
      "orderSuccess.paymentMethods.",
    )
        ...
        <section className="relative overflow-hidden rounded-[30px] border border-champagne-gold/15 bg-midnight-navy shadow-[0_30px_80px_rgba(7,19,31,0.17)]">
          ...
          <div className="relative px-6 py-12 text-center sm:px-10 sm:py-16">
            ...
            <p className="mx-auto mt-5 max-w-[620px] text-[13px] leading-7 text-premium-silver/70 sm:text-[14px]">
              {t(
                "orderSuccess.confirmationDescription",
              )}
            </p>
            ...
            <section className="relative overflow-hidden rounded-[26px] border border-champagne-gold/15 bg-midnight-navy p-6 text-soft-white shadow-[0_25px_65px_rgba(7,19,31,0.17)]">
              ...
              <div className="relative">
                ...
                <div className="flex items-end justify-between gap-4">
                  ...
                  <span className="mb-1 text-[10px] text-classic-gold">
                    ✦
                  </span>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                Object.keys(
                  ...
                  <p className="mt-4 text-[11px] leading-6 text-slate-gray">
                    {t(
                      "orderSuccess.shippingUnavailable",
                    )}
                  </p>
                )}
              </div>
...
const PriceBox = ({
  ...
  return (
    <div>
      ...
      <p
        className={`mt-1 font-serif text-[1rem] font-normal ${
          gold
            ? "text-antique-gold"
            : "text-midnight-navy"
        }`}
...
const SummaryLine = ({
  ...
  return (
    <div className="flex justify-between text-[11px]">
      <span className="text-premium-silver/55">
        {label}
      </span>
...
const AddressRow = ({
  ...
  return (
    <div className="border-b border-light-champagne/70 pb-3 last:border-b-0">
