...
const AdminSidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-72 overflow-hidden border-r border-soft-white/10 bg-midnight-navy text-soft-white shadow-[18px_0_55px_rgba(7,19,31,0.12)] lg:block">
      ...
      <div className="relative border-b border-soft-white/[0.08] px-6 py-7">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        ...
        <div className="relative mx-6 mb-6 border-t border-soft-white/[0.08] pt-5">
