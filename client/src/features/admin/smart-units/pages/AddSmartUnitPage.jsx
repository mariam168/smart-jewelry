  ...
  return (
    <div className="min-h-screen bg-warm-ivory text-midnight-navy">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          <div>
            ...
            <p className="mt-2 text-[13px] text-slate-gray">
              Create a new Smart Unit and its physical inventory
            </p>
          </div>
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        {error && (
          <div className="mb-6 flex gap-3 rounded-[16px] border border-red-200 bg-red-50 px-5 py-4 text-[13px] text-red-700">
            <span>⚠️</span>
        ...
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="space-y-6 lg:col-span-2">
              <section className="overflow-hidden rounded-[24px] border border-light-champagne bg-soft-white">
                <div className="border-b border-light-champagne bg-warm-ivory/40 px-6 py-5">
                ...
                <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-2">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[11px] text-steel-gray">
                        EGP
                      </span>
                    </div>
                  </div>
            ...
            <div>
              <section className="overflow-hidden rounded-[24px] border border-light-champagne bg-soft-white">
                <div className="border-b border-light-champagne bg-warm-ivory/40 px-6 py-5">
                  <h2 className="font-serif text-[1.4rem]">
                    Status
                  </h2>
                </div>
          ...
          <div className="mt-6 flex justify-end gap-3 rounded-[20px] border border-light-champagne bg-soft-white p-5">
            <Link
              to="/admin/smart-units"
              className="rounded-[12px] border border-light-champagne px-6 py-3 text-[11px] font-semibold text-slate-gray"
            >
              Cancel
            </Link>
