...
const EditTechnologyPage = () => {
  ...
  const loadTechnology = async () => {
    try {
      ...
      const technology = response.data.technology;
      ...
      <div className="relative min-h-screen overflow-hidden bg-warm-ivory">
        ...
        <div className="flex min-h-screen items-center justify-center px-6">
          <div className="relative flex flex-col items-center">
            <div className="relative flex h-16 w-16 items-center justify-center rounded-full border border-champagne-gold/25 bg-midnight-navy shadow-[0_12px_30px_rgba(18,38,58,0.15)]">
    ...
    <div className="relative min-h-screen overflow-hidden bg-warm-ivory text-midnight-navy">
      ...
      <main className="relative mx-auto max-w-[920px] px-6 py-12 sm:px-8 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] border border-light-champagne/90 bg-soft-white/85 shadow-[0_20px_60px_rgba(7,19,31,0.055)] backdrop-blur-sm">
          ...
          <div className="pointer-events-none absolute bottom-0 left-0 h-64 w-64 rounded-full bg-champagne-gold/[0.04] blur-[90px]" />
          ...
          >
            {error && (
              <div className="mb-7 flex items-start gap-3 rounded-[16px] border border-antique-gold/25 bg-soft-cream/80 px-5 py-4 text-[10px] leading-5 text-antique-gold shadow-[0_7px_20px_rgba(7,19,31,0.025)]">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-midnight-navy text-[10px] text-champagne-gold">
                  !
                </span>
